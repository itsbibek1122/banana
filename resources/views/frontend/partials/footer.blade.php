<footer class="page-footer black">
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                ...
                @else
                <p class="grey-text text-lighten-4">Room Finder created by Bibek, Epson, Nishant and Sakar.</p>
                @endif
            </div>
                        ...
                        <div class="float-left">
                            <h5 class="font-18 m-b-0 m-t-5">
                                <a href="{{ route('property.show',$property->slug) }}"
                                    class="white-text">{{ Str::limit($property->title,40) }}</a>
                            </h5>
                            <p class="m-t-0 m-b-5 grey-text text-lighten-1">Bedroom: {{ $property->bedroom }} Bathroom:
                                {{ $property->bathroom }} </p>
                        </div>
                    </li>
                    @endforeach
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <a class="grey-text text-lighten-4 right" href="{{ $footersettings[0]['facebook'] }}"
