                    ...
                    <form action="{{route('agent.properties.update',$property->slug)}}" method="POST"
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                ...
                                <textarea id="nearby" name="nearby"
                                    class="materialize-textarea">{{ $property->nearby }}</textarea>
                        ...
                        <div class="row">
                            <div class="file-field input-field col s12">
                                <div class="btn indigo">
                                    ...
                                    <span class="helper-text" data-error="wrong" data-success="right">Upload one or more
                                        images</span>
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text"
